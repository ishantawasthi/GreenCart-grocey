...
const Navbar = () => {
  ...
  const { user, axios,setUser, setShowUserLogin ,setSearchQuery,searchQuery, getCartItemCount }    = useAppContext();
...
/>
        ...
        {!user ? (
          ...
          <div className="relative group">
            ...
            <ul className="hidden group-hover:block absolute top-10 right -0 bg-white shadow border border-grey-200 py-2.5 w-22 rounded-md text-sm z-40  ">
              <li
                onClick={() => navigate('/myorders')}
                className="p-1.5 pl-3  hover:bg-primry/10  cursor-pointer"
              >
                My Orders
              </li>
              <li
